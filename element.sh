...
then
    ...
    then
        ...
        do
            echo "The element with atomic number $ATOMIC_NUM is, $NAME ($SYMBOL). It's a $TYPE, with a mass of $ATOMIC_MASS.  $NAME has a melting point of $MELT_POINT celsius and a boiling point of $BOIL_POINT celsius."
        done
    fi
fi
