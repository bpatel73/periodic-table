...
ALTER SEQUENCE public.types_type_id_seq OWNED BY types.type_id;
...
ALTER TABLE ONLY public.types ALTER COLUMN type_id SET DEFAULT nextval('types_type_id_seq'::regclass);
